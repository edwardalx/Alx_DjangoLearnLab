...
urlpatterns = [
    ...
    path('post/<int:pk>/comments/update/<int:pk>/',view= CommentUpdateView.as_view(), name='update_comments'),
    path('post/<int:pk>/comments/delete/<int:pk>/',view= CommentDeleteView.as_view(), name='delete_comments'),
