...
urlpatterns = [
    ...
    path('books/', view=ListView.as_view(), name='list-books' ),
    path('books/<int:pk>/', view=DetailView.as_view(), name='retrieve-book' ),
    path('books/create', view=CreateView.as_view(), name='create-books' ),
    path('books/update/<int:pk>/', view=UpdateView.as_view(), name='update-book' ),
    path('books/delete/<int:pk>/', view=DeleteView.as_view(), name='delete-book' ),
    path('books/update/<int:pk>/', view=CustomUpdateView.as_view(), name='update-book'),
